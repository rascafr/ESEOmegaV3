...
public class ViewNewsActivity extends AppCompatActivity {
    ...
    private TextView tvName, tvAuthor, tvHtml;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            if(extras == null) {
                Toast.makeText(ViewNewsActivity.this, "Erreur de l'application (c'est pas normal)", Toast.LENGTH_SHORT).show();
                finish();
            } else {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_browser:
                ...
                if (i.resolveActivity(getPackageManager()) != null)
                    ...
                    Toast.makeText(ViewNewsActivity.this, "Pas d'application installée pour ça", Toast.LENGTH_SHORT).show();
                return true;
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            nih.img.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent myIntent = new Intent(ViewNewsActivity.this, ImageViewActivity.class);
